...
String htmlContent = "\
  <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
        body{ display: flex; flex-direction: column; background-image: url(https://i0.wp.com/beauty.gobahub.com/wp-content/uploads/2020/09/IMG_4061.jpg?resize=1000%2C1776&ssl=1); }\
